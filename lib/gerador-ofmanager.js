    ...
    return {
        ...
        gerarListaArtefato: async () => {
            ...
            try {
                ...
                const listaArtefatoAgrupadoPorTarefa = agruparArtefatoPorTarefa(listaArquivo)

                if (!params.mostrarDeletados) {
                    listaTarefaAgrupadaPorArtefato = removerArtefatoDeletado(listaArtefatoAgrupadoPorTarefa)
                }
