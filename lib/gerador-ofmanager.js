...
module.exports = (params) => {
  ...
  //   return listaArtefatoAgrupadoPorTarefa.reduce((accumListaSaida, tarefa) => {
  ...
  //       const listaArtefatoProjeto = tarefa.listaArtefato.filter(
  //         artefato => artefato.nomeProjeto === nomeProjeto)

  //       // Filtra as extensões que estão na lista de artefatos que contem a tarefa do loop
  //       const listaTipoArtefato = listaArtefatoProjeto.reduce((listaRetorno, artefato) => {
