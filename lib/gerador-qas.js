...
module.exports = (params) => {
  ...
  function obterListaArtefatoSemTarefaRenomear(artefato, listaArtefatoSemTarefaRenomear) {
  ...
  function obterListaArtefatoComTarefaRenomear(artefato, listaArtefatoComTarefaRenomear) {
  ...
  */
  ...
  function isMostrarRenomeados(params, commit) {
    return params.mostrarRenomeados && commit.isTipoAlteracaoRenomear()
  }

  function isMostrarDeletados(params, commit) {
    ...
    return listaArquivo.reduce((accum, arquivoReduce) => {
      ...
      if (arquivoReduce.commit.isTipoAlteracaoModificacao() ||
        arquivoReduce.commit.isTipoAlteracaoAdicionar() ||
          isMostrarRenomeados(params, arquivoReduce.commit) || 
            isMostrarDeletados(params, arquivoReduce.commit)) {
