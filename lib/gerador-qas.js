...
module.exports = (params) => {
  ...
  function obterListaSaidaTarefasUmArtefato(listaArtefatoComTarefaDiferentesMesmoTipo) {

    return listaArtefatoComTarefaDiferentesMesmoTipo.map((artefato) => {
  ...
  function filtrarArtefatoComTarefaMesmoTipo(listaArtefato) {
    ...
    for (const artefato of listaArtefato) {
      ...
      if (artefato.listaTarefa.length > 1) {
        ...
        // TODO - refatorar
        const listaTarefasDiferentesMesmoTipo = artefato.listaTarefa
        ...
        if (listaTarefasDiferentesMesmoTipo.length) {

          listaArtefatoTarefaMesmoTipo.push(
            new Artefato({
              nomeArtefato: artefato.nomeArtefato,
              listaTarefa: listaTarefasDiferentesMesmoTipo
            }))
        }
      }
    }
