...
module.exports = (params) => {
  ...
  return {
    ...
    gerarListaArtefato: async () => {
      ...
      try {
        ...
        const listaArtefatoComTarefaMesmoTipo = obterListaArtefatoComTarefaMesmoTipo(listaTarefaAgrupadaPorArtefato)
        const listaArtefatoSemTarefaMesmoTipo = obterListaArtefatoSemTarefaMesmoTipo(listaTarefaAgrupadaPorArtefato)
  ...
  function obterListaSaidaTarefasUmArtefato(listaArtefatoComTarefaNumerosDiferentesMesmoTipo) {

    return listaArtefatoComTarefaNumerosDiferentesMesmoTipo.map((artefato) => {
      ...
      let artefatoSaida = new ArtefatoSaida({
    ...
    saida.listaArtefatoSaida = listaAgrupamento.reduce((listaRetorno, artefato) => {
      ...
      for (const tarefa of listaTarefa) {
        ...
        const artf = new ArtefatoSaida({
          ...
          nomeAntigoArtefato: tarefa.nomeAntigoArtefato,
          nomeNovoArtefato: tarefa.nomeNovoArtefato
        })
  ...
  */
  function obterListaArtefatoComTarefaMesmoTipo(listaArtefato) {
  ...
  */
  function obterListaArtefatoSemTarefaMesmoTipo(listaArtefato) {
